...
public class NonBlockClient {
	...
	private static Logger log = LoggerFactory.getLogger(NonBlockClient.class);
	...
	public static void main(String[] args) throws Exception {
		...
		while (true && channel != null) {
			RpcService.Interface nonService = RpcService.newStub(channel);
			...
			nonService.call(controller, request, new RpcCallback<Message.Response>() {
				...
				public void run(Response response) {
					...
					log.info("response msg : "+response.getMsg());
