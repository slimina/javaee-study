...
public class EhcacheTest4000 {

	public static void main(String[] args) throws Exception {
		//在一些启用了 IPv6 添加
		System.setProperty("java.net.preferIPv4Stack", "true");
		ApplicationContext context = 
				//new ClassPathXmlApplicationContext("applicationContext-rmi-4000.xml");
				new ClassPathXmlApplicationContext("applicationContext-jgroups-4000.xml");
