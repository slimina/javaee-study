package cn.slimsmart.zookeeper.curator.demo.crud;
...
public class TransactionTest {
	...
	public static void main(String[] args) {
		try {
			...
			Collection<CuratorTransactionResult> results = transaction.create().forPath("/a/path", "some data".getBytes()).and().setData()
